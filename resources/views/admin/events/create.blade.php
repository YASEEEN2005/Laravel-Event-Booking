    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <main class="lg:col-span-9 space-y-6">
            ...
            <div class="premium-card rounded-2xl p-6 sm:p-8">
                <form method="POST" action="/admin/events" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                <input id="title" type="text" name="title" value="{{ old('title') }}" required placeholder="e.g. Acoustic Sessions Live 2026"
                        ...
                        <div>
                            ...
                            <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                <input id="location" type="text" name="location" value="{{ old('location') }}" required placeholder="e.g. San Francisco, CA"
                                    class="w-full px-4 py-3 bg-transparent border-0 text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-0">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 md:col-span-2">
                            <div>
                                ...
                                <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                    <input id="available_seats" type="number" name="available_seats" value="{{ old('available_seats') }}" required placeholder="150" min="1"
                                        class="w-full px-4 py-3 bg-transparent border-0 text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-0">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                    <input id="price" type="number" name="price" value="{{ old('price') }}" required placeholder="89.00" min="0" step="0.01"
                                        class="w-full px-4 py-3 bg-transparent border-0 text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                <textarea id="description" name="description" rows="4" required placeholder="Describe what attendees should expect..."
                                    class="w-full px-4 py-3 bg-transparent border-0 text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-0 resize-none">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                                <input id="image" type="url" name="image" value="{{ old('image') }}" placeholder="https://images.unsplash.com/..."
                                    class="w-full px-4 py-3 bg-transparent border-0 text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:ring-0">
                            </div>
                        </div>
                    </div>
