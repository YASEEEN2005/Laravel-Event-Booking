...
@section('title', 'Register - EventHub')
    ...
    <div class="relative py-12 flex items-center justify-center">
        ...
        <div class="w-full max-w-md rounded-3xl glass-card border border-white/5 p-8 relative shadow-2xl overflow-hidden">
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-slate-400 mt-2">Join EventHub to discover and book premium experiences</p>
            </div>
            ...
            <form method="POST" action="/register" class="space-y-5" onsubmit="event.preventDefault();">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative rounded-xl bg-slate-950/80 border border-white/10 hover:border-slate-700 focus-within:border-indigo-500 focus-within:shadow-[0_0_15px_rgba(99,102,241,0.15)] transition-all duration-200">
                        ...
                        <input id="password-confirm" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" 
                            class="w-full pl-11 pr-11 py-3 bg-transparent border-0 text-white placeholder-slate-600 text-sm focus:outline-none focus:ring-0">
                        <button type="button" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-500 hover:text-slate-300 transition" id="toggle-confirm-password" aria-label="Toggle Confirm Password Visibility">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="text-slate-400 select-none cursor-pointer">I agree to the <a href="#" class="text-indigo-400 hover:underline">Terms of Service</a> and <a href="#" class="text-indigo-400 hover:underline">Privacy Policy</a></label>
                    </div>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-white/5 text-center">
                <p class="text-sm text-slate-400">
                    ...
                    <a href="/login" class="font-bold text-indigo-400 hover:text-indigo-300 transition">Sign in</a>
                </p>
            </div>
        </div>
    </div>
