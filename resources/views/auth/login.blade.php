    ...
    <div class="py-12 flex items-center justify-center">
        <div class="w-full max-w-md rounded-3xl bg-white border border-slate-100 p-8 relative shadow-xl overflow-hidden">
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-slate-400 mt-2">Sign in to your EventBook account</p>
            </div>
            ...
            <form method="POST" action="/login" class="space-y-5" onsubmit="event.preventDefault();">
                ...
                <div>
                    ...
                    <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', 'demo@eventbook.com') }}" required autocomplete="email" placeholder="name@company.com" 
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="#" class="text-xs font-semibold text-[#4F46E5] hover:text-[#4338CA] transition">Forgot Password?</a>
                    </div>
                    <div class="relative rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 focus-within:border-[#4F46E5] focus-within:bg-white transition-all duration-200">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex items-center">
                    ...
                    <label for="remember_me" class="ml-2 text-sm text-slate-500 select-none cursor-pointer hover:text-slate-700">Remember this device</label>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-100 text-center">
                <p class="text-sm text-slate-500">
                    ...
                    <a href="/register" class="font-bold text-[#4F46E5] hover:text-[#4338CA] transition">Create account</a>
                </p>
            </div>
        </div>
    </div>
